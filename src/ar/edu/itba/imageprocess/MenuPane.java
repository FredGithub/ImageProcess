...
public class MenuPane extends JPanel implements ActionListener {
	...
	public MenuPane(MainController controller) {
		...
		mHisteresis = new JButton("Histeresis");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == mLoadBtn) {
		...
		} else if (e.getSource() == mHisteresis) {
			ParamAsker params = new ParamAsker();
			...
			ParamAsker params = new ParamAsker();
			params.addParam(new Param(Param.TYPE_INTEGER, "angleCount", "200"));
			params.addParam(new Param(Param.TYPE_INTEGER, "distCount", "200"));
